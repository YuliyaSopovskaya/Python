...
print('\nВас приветсвует телефонная книга!')
...
def ls_menu():
    while True:
        ...
        print('4. Найти по номеру телефона.')
        ...
        if n == 1:
            ...
            search = input('Введите номер тел: ')
            lg.logging.info('User entered: {search}')
            ...
            if change == 1:
                ...
                new_number = input('Введите новый номер тел: ')
                ...
                lg.logging.info('User entered an invalid menu valuse')
                print('\nТакого пункта не существует.\nВведите соотвтсвующею цифру.')
            ...
            if deleting == 1:
                ...
                print('\nТакого пункта меню не существует.\nВведите цифру, соответвующею меню.')
            ...
            print('\nТакого пункта меню нет.\nВведите цифру соответсвующее меню')


def checking_the_number(arg):
    while arg.isdigit() != True:
        lg.logging.info('User entered an invalid menuvaluse: {arg}')
        print('\nВведено не число.')
